 ...
 */
class poodllrecording implements \mod_jazzquiz\questionmodifiers\ibasequestionmodifier {
    ...
    public function add_css() {
        global $PAGE;
        $PAGE->requires->css('/mod/jazzquiz/js/questionmodifiers/poodllrecording/lightbox/css/lightbox.css');
        $PAGE->requires->css('/mod/jazzquiz/js/questionmodifiers/poodllrecording/styles.css');
    }
    ...
    public function add_js() {
        global $PAGE;
        $PAGE->requires->js('/mod/jazzquiz/js/questionmodifiers/poodllrecording/lightbox_images.js');
        $PAGE->requires->js('/mod/jazzquiz/js/questionmodifiers/poodllrecording/lightbox/lightbox.min.js');
    ...
    public function modify_questionresults_duringquiz($question, $attempts, $output) {
        ...
        if ($questiondef->responseformat == 'picture') {
            ...
            $picturejs .= '
                jazzquiz.questionmodifiers.poodllrecording.lightbox_images();
            ';

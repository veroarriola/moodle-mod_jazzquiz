...
jazzquiz.ajax = {
    ...
    create_request: function (url, params, callback) {
        ...
        if (params instanceof FormData) {
            params.append('id', jazzquiz.quiz.course_module_id);
            params.append('quizid', jazzquiz.quiz.activity_id);
            params.append('sessionid', jazzquiz.quiz.session_id);
            params.append('attemptid', jazzquiz.quiz.attempt_id);
            params.append('sesskey', jazzquiz.quiz.session_key);
        } else if (params !== null) {
            params.id = jazzquiz.quiz.course_module_id;
            params.quizid = jazzquiz.quiz.activity_id;
            params.sessionid = jazzquiz.quiz.session_id;
            params.attemptid = jazzquiz.quiz.attempt_id;
